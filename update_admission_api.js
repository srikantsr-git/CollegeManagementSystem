...
fetch('http://localhost:5001/api/admissions/1', {
  method: 'PUT',
  headers: {
    'Content-Type': 'application/json'
  },
  body: JSON.stringify({
    course_name: 'Certificate / Foundation Course in Yoga Education (FCYE)',
    intro_text: fullHtml,
    course_subtitle: 'Foundation Course in Yoga Education'
  })
